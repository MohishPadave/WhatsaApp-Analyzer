...
export function DeveloperSlide({
  ...
  // Render static high-res view for export
  if (isExport) {
    return (
      <div className="flex flex-col justify-between h-full py-12 text-left w-full text-slate-100">
        <div className="space-y-8">
          ...
          <p className="text-xl font-bold text-sky-400/90 mt-2 leading-relaxed">
            Verdict: {stats.topCodeSpammer.name} is treating this WhatsApp chat like a GitHub pull request code review.
          </p>
        </div>

        {/* IDE Terminal Window Mock */}
        <div className="bg-[#0f141c]/90 border border-slate-700/60 rounded-[45px] p-12 shadow-2xl space-y-8 w-[780px] my-auto mx-auto font-mono text-left relative overflow-hidden">
          {/* Terminal header */}
          ...
          <div className="space-y-6 text-xl">
            ...
            <p className="text-slate-400 italic border-l-4 border-sky-500 pl-4 py-2 mt-4 bg-slate-900/30 rounded-r-xl">
